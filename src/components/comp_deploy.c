/**
 * @file comp_deploy.c
 * @brief Single-line deploy status: branch chip, time-ago, and outcome label.
 */
...
static void draw(xf_draw_ctx_t *ctx, int w, int h, void *user_data)
{
    ...
    /* Branch chip — semi-transparent pill */
